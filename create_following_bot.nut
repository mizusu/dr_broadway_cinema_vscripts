...
function spawnBot() {
    ...
    class ::Bot
    {
        constructor(spawn_origin, target = null)
        {
            ...
            // For female human.
            seq_idle = bot.LookupSequence("idle_angry")
            seq_run = bot.LookupSequence("run_all")
            pose_move_x = bot.LookupPoseParameter("move_x")
    ...
    ({
        ...
        // early_out	= null
        // damage_bonus	= 0
        // damage_force	= (vector : (-2349.882812, 209.272568, -440.745209)
        // damage_position	= (vector : (42.427956, 176.558014, 115.257179)
        // damage	= 40
        // const_entity	= ([89] base_boss: random_bot__2b319_)
        // inflictor	= ([1] player)
        // damage_for_force_calc	= 0
        // ammo_type	= -1
        // attacker	= ([1] player)
        // reported_position	= (vector : (0.000000, 0.000000, 0.000000)
        // force_friendly_fire	= false
        // player_penetration_count	= 0
        // damaged_other_players	= 0
        // damage_custom	= 0
        // const_base_damage	= 40
        // damage_stats	= 0
        // damage_bonus_provider	= null
        // max_damage	= 40
        // weapon	= ([78] tf_weapon_revolver)
        // }
        function OnScriptHook_OnTakeDamage(params)
        {
            printl("CFB: OnScriptHook_OnTakeDamage called");
			...
			recordPatronDamage(params);
        }

        // params:
        // CFB: OnGameEvent_npc_hurt called
        // CFB: params: (table : 0x000001AF98ACDC00)
        // CFB: params:
        // {
        //      damageamount	= 58
        //      health	= 2147483647
        ...
        {
			printl("CFB: OnGameEvent_npc_hurt called");
